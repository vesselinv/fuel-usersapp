...
return array(
	...
	'unique'					=> 'Chosen :label is already taken.',
	'username'				=> ':label can only contain alphanumeric characters and underscores.',
	'valid_mysql_date'=> ':label must be in the following format: YYYY-MM-DD',
);
